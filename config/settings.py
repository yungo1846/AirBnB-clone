...
AUTH_USER_MODEL = "users.User"  # 사용자 커스텀 모델
...
EMAIL_FROM = "airbnb@sandbox258297200b914508ae651407886e84b8.mailgun.org"
...
if not DEBUG:
    ...
    AWS_STORAGE_BUCKET_NAME = "airbnb-clone-yungo1468"
